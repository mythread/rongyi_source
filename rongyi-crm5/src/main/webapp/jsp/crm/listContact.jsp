...
<script type="text/javascript">
    $(document).ready(function(){
	  ...
	  var mygrid = jQuery("#grid").jqGrid({
			...
			mtype: 'POST',
			height: "auto",
		   	colNames:['<s:text name="entity.id.label" />','<s:text name="entity.last_name.label" />',
		   	       '<s:text name="entity.first_name.label" />','<s:text name="entity.title.label" />',
		   	       '<s:text name="entity.account.label" />','<s:text name="entity.email.label" />',
		   	       '<s:text name="entity.assigned_to.label" />','<s:text name="menu.contact_default.title" />',
		   	...
		   	colModel:[
		   		...
		   		{name:'office_email',index:'office_email', width:150, resizable:true, formatter:urlFmatter},
		   		{name:'assigned_to.name',index:'assigned_to.name', width:150, resizable:true, formatter:urlFmatter},
		   		{name:'contact_default',index:'contact_default', width:150, resizable:true, formatter:urlFmatter},
