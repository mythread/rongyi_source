...
<script type="text/javascript">
	...
	function sendInvites() {
		...
		addObjectForm.action = 'sendInvitesVisit.action';
	...
	$(document).ready(function() {
		...
		$("#relatedObject ").val('<s:property value="visit.related_object"/>');		
			...
			onSelect:function(title){
		        if (title == "<s:text name='tab.invitees'/>"){
					 var params = {
					  ...
					  $.ajax({
					    type: "POST",
					    url: "getVisitRelationCounts.action",
					    data: params,
					    dataType:"text", 
    ...
    <div id="feature">
      <div id="shortcuts" class="headerList">
        <b style="white-space: nowrap; color: #444;"><s:text
          ...
          <!--<s:if test="visit!=null && visit.id!=null">
              <span style="white-space: nowrap;"><a
                ...
                <div id="mtm1" style="width: 150px;">
                  <div data-options="iconCls:'icon-import'"
                    onClick="openwindow2('/crm/showChangeLogPage.action?entity=Visit&recordID=' + '<s:property value="visit.id" />',750,500)">
      ...
      <div id="feature-title">
        <s:if test="visit!=null && visit.id!=null">
          <h2>
            <s:text name="title.updateVisit" />
          </h2>
        </s:if>
        <s:else>
          <s:if test="seleteIDs!=null && seleteIDs!= ''">
            <h2>
              <s:text name="title.massUpdateVisit" />
            </h2>
          </s:if>
          <s:else>
            <h2>
              <s:text name="title.createVisit" />
            </h2>
          </s:else>
        </s:else>
      </div>
      ...
      <div id="feature-content">
        <s:form id="addObjectForm" validate="true" namespace="/jsp/crm"
          method="post">
          <s:hidden id="id" name="visit.id" value="%{visit.id}" />
          ...
          <table style="padding: 10px;" cellspacing="10" cellpadding="0"
            ...
            <tr>
              ...
              <td class="td-value"><input name="visit.subject"
                class="easyui-validatebox record-value"
                data-options="required:true"
                value="<s:property value="visit.subject" />" /></td>
              <td class="td-mass-update"><input id="massUpdate"
                name="massUpdate" type="checkbox" class="massUpdate"
                value="status" /></td>
              <td class="td-label"><label class="record-label"><s:text
              ...
              <table style="" cellspacing="10" cellpadding="0"
                ...
                <tr>
                  ...
                  <td class="td-value"><select id="relatedObject"
                    name="visit.related_object" style="width: 150px;">
                    ...
                    <table>
                      <tr>
                        <td style="text-align: left; width: 35%;">
                          <s:checkbox id="visit.reminder_email"
                            name="visit.reminder_email"
                ...
                <tr>
                  <td class="td-mass-update"><input id="massUpdate"
                    ...
                    value="location" /></td>
                  <td class="td-label"><label class="record-label"><s:text
                        name="visit.location.label"></s:text>：</label></td>
                  <td class="td-value"><s:textfield
                      name="visit.location" cssClass="record-value" />
                  </td>
                  <td class="td-mass-update"><input id="massUpdate"
                    name="massUpdate" type="checkbox" class="massUpdate"
                ...
                <tr>
                  ...
                  <td class="td-value" valign="top"><s:textarea
                      name="visit.notes" rows="5" cssStyle="width:350px;" cssClass="record-value" /></td>
                  <td class="td-mass-update"></td>
                  <td class="td-label"></td>
                  <td class="td-value"></td>                         
                </tr>                    
                  ...
                  <td width="20%" valign="top">
                    <div class="easyui-accordion" style="width: 200px;">
                      <div title="<s:text name="menu.sales.title"/>"
                        ...
                        selected="true">
                        <a
                          href="relatevisitContactPage.action?id=<s:property value="visit.id" />"
                          ...
                          href="relatevisitLeadPage.action?id=<s:property value="visit.id" />"
                          target="contentFrame"><label
                          class="record-value menuLink"><s:text
                      ...
                      <div title="<s:text name="menu.system.title"/>"
                        style="overflow: auto; padding: 10px;">
                        <a
                          href="relateVisitUserPage.action?id=<s:property value="visit.id" />"
                          target="contentFrame"><label
                          class="record-value menuLink"><s:text
