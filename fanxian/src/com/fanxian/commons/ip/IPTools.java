package com.fanxian.commons.ip;
...
public class IPTools {
    ...
    // 纯真IP数据库(QQ)
    // private String                        IP_FILE          = "/yueji/data/ip_qqwry.dat";
    ...
    // 单一模式实例
    private static IPTools     instance         = null;
    // 起始地区的开始和结束的绝对偏移
     ...
     * 私有构造函数
     */
    private IPTools(String ipFilePath) {
     ...
     * @return 单一实例
     */
    public synchronized static IPTools getInstance(String ipFilePath) {
        if(instance == null){
            instance = new IPTools(ipFilePath);
        }
        return instance;
    }
