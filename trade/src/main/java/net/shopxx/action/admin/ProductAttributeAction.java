 ...
 *  
 * ----------------------------------------------------------------------------
 *  BF29C1240A7C6969E02F8F49566B5C42
 * ============================================================================
 */
...
public class ProductAttributeAction extends BaseAdminAction {
	...
	public String save() {
		...
		productAttribute.setStatus(StatusEnum.ENABLE.getValue());
		Date date = new Date();
		productAttribute.setCreateDate(date);
		productAttribute.setModifyDate(date);
