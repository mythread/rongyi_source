 ...
 * ---------------------------------------------------------------------------- 。
 * ----------------------------------------------------------------------------
 * ---------------------------------------------------------------------------- A422025AB3BAEE5940EB4488D12B6691
 * ============================================================================
 */

@Entity
@Searchable
@Table(name = "ry_product")
public class Product implements Serializable {
    ...
    // 以下是新增的字段
    private Integer                       sourcePrice;                        // 商品吊牌价格，以分为单位
    private Integer                       activityPrice;                      // 商品活动价
    private String                        buyerId;                            // 买手id

    private String                        mallId;                             // 商场id；
    private Integer                       isActivity                     = 0; // 是否参加活动,0:参加；1：不参加
    private Integer                       activityId;                         // 活动ID
    private Date                          gmtActivityStart;                   // 活动开始时间
    private Date                          gmtActivityEnd;                     // 活动结束时间
    private String                        memo;                               // 备注
    /**
     * @see ProductStatusEnum
     */
    private String                        productStatus;                      // 商品状态：待发布，已发布，已上线，已下线，已删除
    private String                        sourcePriceStr;                     // 模板传进来的数值
    ...
    public BigDecimal getPreferentialPrice(Member member) {
        if (member != null) {
            BigDecimal preferentialPrice = price.multiply(new BigDecimal(
                                                                         member.getMemberRank().getPreferentialScale().toString()).divide(new BigDecimal(
                                                                                                                                                         "100")));
    ...
    public String getActivityPriceStr() {
        return activityPriceStr;
    }

    public void setActivityPriceStr(String activityPriceStr) {
