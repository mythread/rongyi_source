...
<title>管理中心首页 -${systemConfig.systemName}</title>
...
<body class="admin">
	<div class="adminBar">
		<span class="icon">&nbsp;</span>欢迎使用容易网扫货管理系统！
	</div>
	<div class="body">
		<div class="bodyLeft">
			<table class="listTable">
				...
				<tr>
					...
					<td>
						<a href="http://www.rongyi.com">http://www.rongyi.com</a>
					</td>
				</tr>
		...
		<p class="copyright">Copyright © 2014 rongyi.com All Rights Reserved.</p>
	</div>
</body>
</html>