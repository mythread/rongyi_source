		...
		<form id="inputForm" class="validate" action="<#if isAdd??>product!save.action<#else>product!update.action</#if>" method="post" enctype="multipart/form-data" >
			...
			<table class="inputTable tabContent">
				...
				<tr>
					...
					<td>
						<input type="text" name="product.sourcePriceStr" class="formText {required: true, min: 0}" value="${(product.sourcePrice)!"0"}" />
						<label class="requireField">*</label>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="product.activityPriceStr" class="formText {required: true, min: 0}" value="${(product.activityPrice)!"0"}" />
						<label class="requireField">*</label>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select name="product.mallId">
							<option>请选择商场...</option>
							<option value="1">大悦城</option>
							<option value="2">美罗城</option>
							<option value="3">太平洋</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="product.activityId">
							<option>请选择活动...</option>
				...
				<tr>
					...
					<td>
						<textarea name="product.memo" class="formTextarea">${(product.memo)!}</textarea>
					</td>
				</tr>
