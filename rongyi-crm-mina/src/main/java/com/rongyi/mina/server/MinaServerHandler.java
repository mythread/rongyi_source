...
public class MinaServerHandler extends IoHandlerAdapter {
    ...
    private CmsTaskService      cmsTaskService      = ServiceFactoryBean.getCmsTaskService();
    private OperateMongoService operateMongoService = ServiceFactoryBean.getOperateMongoService();
